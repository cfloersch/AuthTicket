 ...
 */
public class CustomBackUrlUseCaseTest {
   ...
   @Test
   public void testXBackUrlHeader() throws ServletException, IOException
   {
      when(request.getCookies()).thenReturn(new Cookie[0]);
      when(request.getHeader(eq("X-Back-Url"))).thenReturn("https://simulcast-ui.manheim.com/simulcast/web2page.html");
      ...
      verify(response, times(1)).sendRedirect(eq("https://www.manheim.com/login?back=https://simulcast-ui.manheim.com/simulcast/web2page.html"));
